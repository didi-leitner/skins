...
class BottomSheetScrimView(context: Context, attrs: AttributeSet) : View(context, attrs) {
     ...
     */
    fun updateThumbnail(thumbnailBitmap: Bitmap) {
        this.thumbnailBitmap = thumbnailBitmap
    }

    fun updateSrcThumb(srcThumbnailRect: RectF) {
        this.srcThumbnailRect = srcThumbnailRect
    }

    fun translateAndScaleThumbnail(
            collapsedStateHeight: Int,
            slideOffset: Float,
